...
<head>
  ...
  <title>Sistem Informasi Tata Ruang Kota Pasuruan</title>
...
<body>
<!-- Just an image -->
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color: #537ec5;">
  <div class="container">
  <a class="navbar-brand" href="#">
    <img src="<?= base_url("assets/"); ?>logo.png" width="44" height="44" alt="">
  </a>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="card mb-4 shadow-sm">
              <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
              <div class="card-body text-center">
                <h3><a href="<?= base_url('pemohon/login'); ?>">Pengajuan Formulir</h3>
...
<footer class="text-muted">
  <div class="container">
    <p>&copy; 2019 Tata Ruang</p>
    <p>Dinas Pekerjaan Umum dan Penataan Ruang Kota Pasuruan</p>
    <p>Jl. Pahlawan No. 22 A Telp. (0343) 424524 Fax. (0343) 425582 Pasuruan 67126</p>
  </div>
</footer>
