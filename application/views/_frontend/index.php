...
<html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?= base_url('assets/frontend/'); ?>assets/css/animate.css">
        <link rel="stylesheet" href="<?= base_url('assets/frontend/'); ?>assets/css/owl.carousel.css">
        <link rel="stylesheet" href="<?= base_url('assets/frontend/'); ?>assets/css/owl.theme.css">
        <link rel="stylesheet" href="<?= base_url('assets/frontend/'); ?>assets/css/style.css">


        <!-- scripts -->
        <script type="text/javascript" src="<?= base_url('assets/frontend/'); ?>assets/js/modernizr.custom.97074.js"></script>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="navbar-brand">
                            <span class="sr-only">SIMTARU</span>
                            <a href="index.html">
                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/cc.jpg" class="img-responsive center-block" alt="logo">
                            </a>
                        </div>
                        <!-- navbar logo -->
                    ...
                    <div class="collapse navbar-collapse" id="main-nav-collapse">
                        <ul class="nav navbar-nav navbar-right text-uppercase">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span>peta</span></a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="about.html">permohonan ijin</a>
                                    </li>
                                    <li>
                                        <a href="service.html">kontak</a>
                                    </li>
                                    <li>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span>permohonan ijin</span></a>
                                <ul class="dropdown-menu">
                                    <li>
            ...
            <div class="main-content">
                ...
                <section class="intro bg-light-gray">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/intro.jpg" class="img-responsive center-block" alt="intro">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="portfolio-item">
                                        <div class="item-image">
                                            <a href="#">
                                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/portfolio4.jpg" class="img-responsive center-block" alt="portfolio4">
                                                <div><span><i class="fa fa-plus"></i></span></div>
                                            </a>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="portfolio-item">
                                        <div class="item-image">
                                            <a href="#">
                                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/portfolio5.jpg" class="img-responsive center-block" alt="portfolio5">
                                                <div><span><i class="fa fa-plus"></i></span></div>
                                            </a>
                                        </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="portfolio-item">
                                        <div class="item-image">
                                            <a href="#">
                                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/portfolio6.jpg" class="img-responsive center-block" alt="portfolio6">
                                                <div><span><i class="fa fa-plus"></i></span></div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="client-box">
                                            <div class="about-client">
                                                <img src="<?= base_url('assets/frontend/'); ?>assets/img/client1.jpg" alt="client1">
        ...
        <script type="text/javascript" src="<?= base_url('assets/frontend/'); ?>assets/js/jquery-2.1.3.min.js"></script>
        <script type="text/javascript" src="<?= base_url('assets/frontend/'); ?>assets/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?= base_url('assets/frontend/'); ?>assets/js/owl.carousel.js"></script>
        <script type="text/javascript" src="<?= base_url('assets/frontend/'); ?>assets/js/jquery.hoverdir.js"></script>
